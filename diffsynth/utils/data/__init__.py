...
def save_video(frames, save_path, fps, quality=9, ffmpeg_params=None, show_progress=True):
    writer = imageio.get_writer(save_path, fps=fps, quality=quality, ffmpeg_params=ffmpeg_params)
    for frame in tqdm(frames, desc="Saving video", disable=not show_progress):
